...
def sem_img_gather_folders(vsem_dir, seconds_lookback, obs_folder_name):
    ...
    '''
    meas_dirs: list of list, each index is
...
if __name__ =="__main__":
    ...
    number_minutes_lookback = 60 * 8
    seconds_lookback = 60*number_minutes_lookback
    add_to_flask_db = False
    ...
    tool = 'vera401'
    obs_img_bool = True
    start_scrape_and_db_pop(seconds_lookback, db_file, db_table, vsem_dir, obs_folder_name, new_table, tool, obs_img_bool,add_to_flask_db, db_file_flask)
    ...
    vsem_dir = "//home//ccag//Desktop//verity401//images//AutoSave//Production//Production//Production//"
    db_table = "measdisplay_obs"
    obs_folder_name = "MeasDisplay"
    new_table = "measdisplay_obs"
    tool = 'verity401'
